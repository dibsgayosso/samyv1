		...
		<div class="panel">
			<div class="panel-body">
               ...
               <?php
					...
					{
					?>
						<a href="#" class="list-group-item" id="invoices"><i class="icon ti-bar-chart"></i>	<?php echo lang('reports_invoices_reports'); ?></a>
					<?php } ?>
		...
		<div class="panel">
			...
			<h3 id="right_heading" class="page-header text-info"><i class="icon ti-angle-double-left"></i><?php echo lang('reports_make_a_selection')?></h3>
				...
				<div class="list-group items hidden">
					...
					<a href="<?php echo site_url('reports/generate/enhanced_summary_items');?>" class="list-group-item"><i class="icon ti-receipt"></i> <?php echo lang('reports_enhanced_summary_reports') ?></a>
				...
				<div class="list-group invoices hidden">
					<a href="<?php echo site_url('reports/generate/customer_invoices');?>" class="list-group-item"><i class="icon ti-stats-down"></i> <?php echo lang('reports_customer_invoices'); ?></a>
					<a href="<?php echo site_url('reports/generate/supplier_invoices');?>" class="list-group-item"><i class="icon ti-receipt"></i> <?php echo lang('reports_supplier_invoices'); ?></a>
				</div>
				...
				<div class="list-group store-accounts hidden">
					...
					<?php if ($this->config->item('customers_store_accounts') && $this->Employee->has_module_action_permission('reports', 'view_store_account', $this->Employee->get_logged_in_employee_info()->person_id)) { ?>					
						<h4 class="text-info"><?php echo lang('reports_customers')?></h4>
                                                ...
                                                <a href="<?php echo site_url('reports/generate/bad_store_account_customers');?>" class="list-group-item"><i class="icon ti-alert"></i> <?php echo lang('reports_bad_store_account_customers'); ?></a>
                                                ...
                                                <a href="<?php echo site_url('reports/generate/inactive_store_accounts');?>" class="list-group-item"><i class="icon ti-alert"></i> <?php echo lang('reports_inactive_customer_accounts'); ?></a>
