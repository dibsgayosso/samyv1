						...
						<ul class="list-unstyled invoice-detail" style="margin-bottom:2px;">
							...
							<?php
                                                        if (version_compare(PHP_VERSION, '7.2', '>=')  && function_exists('bcadd')) {
                                                                ...
                                                                ?>
                                                                <li class="remove_when_mobile"><span><?php echo lang('sales_branch_folio_id_label', '', array(), TRUE) . ":"; ?></span><?php echo H($location_folio_display); ?></li>
                                                                <li class="keep_when_mobile" style="display: none"><span><?php echo lang('sales_branch_folio_id_label', '', array(), TRUE) . ":"; ?></span><?php echo H($location_folio_display); ?></li>

                                                                <?php
                                                        } else {
                                                                ?>
                                                                <li><span><?php echo lang('sales_branch_folio_id_label', '', array(), TRUE) . ":"; ?></span><?php echo H($location_folio_display); ?></li>
                                                                <?php
                                                        }
                                                                ?>
...
?>
<?php echo lang('sales_branch_receipt_number', '', array(), TRUE) . ": " . H($location_folio_display); ?>
<?php echo lang('sales_global_folio_label', '', array(), TRUE) . ": " . $sale_id; ?>
<?php if (isset($sale_type)) { ?>
<?php echo $sale_type; ?>
<?php } ?>
