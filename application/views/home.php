...
datasets: [
{
label: <?php echo json_encode(lang('reports_sales_summary_report')); ?>,
fillColor: "#5d9bfb",
strokeColor: "#5d9bfb",
highlightFill: "#5d9bfb",
highlightStroke: "#5d9bfb",
data: locationSales.totals
}
]
};

var locationCtx = document.getElementById('location_bar').getContext('2d');
new Chart(locationCtx).Bar(locationData, {
responsive: true,
scaleLabel: "<%=value%> " + currencySymbol
});
}
