...
<li>
<?php echo anchor("$controller_name/active_employees_template",'<span class="ion-ios-download-outline"> '.lang('employees_active_template').'</span>',
array('class'=>'hidden-xs import','title'=>lang('employees_active_template'))); ?>
</li>
<li>
<?php echo anchor("$controller_name/active_template_import",'<span class="ion-ios-cloud-upload-outline"> '.lang('employees_active_template_import').'</span>',
array('class'=>'hidden-xs import','title'=>lang('employees_active_template_import'))); ?>
</li>
<?php } ?>
<?php } ?>
<?php } ?>
