...
$lang['gmail_api_token_registered'] = 'PHP Point Of Sale è ora autorizzato a inviare e-mail per conto del tuo account Gmail. Puoi chiudere questa finestra.';
...
$lang['config_use_sa_einvoice'] = 'Utilizza la fatturazione elettronica SA';
$lang['config_download_sdk_desc_fill_csr'] = 'Scarica e installa l\'SDK (Fatoora) per utilizzare il sistema di fatturazione elettronica SA. E compila gli input csr di seguito.';
$lang['config_saudi_tax_common_name_placeholder'] = 'Nome o numero di tracciabilità dell\'asset per l\'unità della soluzione';
$lang['config_saudi_tax_sn'] = 'Numero di serie dell\'EGS';
$lang['config_saudi_tax_sn_placeholder'] = 'Nome del produttore o del provider di soluzioni, modello o versione e numero di serie';
$lang['config_saudi_tax_org_id'] = 'Identificatore dell\'organizzazione';
$lang['config_saudi_tax_org_unit_name'] = 'Nome unità organizzativa';
$lang['config_saudi_tax_org_name'] = 'Nome dell\'organizzazione';
$lang['config_saudi_tax_payer_name'] = 'Nome del contribuente';
$lang['config_saudi_tax_country_name'] = 'Nome del paese';
$lang['config_saudi_tax_invoice_type_placeholder'] = 'Tipo di fattura, TSCZ ad esempio: 1111';
$lang['config_saudi_tax_invoice_type'] = 'Tipo di fattura';
$lang['config_saudi_tax_location_placeholder'] = 'Posizione della filiale o del dispositivo o dell\'unità della soluzione. Preferibilmente l\'%00indirizzo breve%00 dall\'indirizzo nazionale saudita';
$lang['config_saudi_tax_industry'] = 'Industria';
$lang['config_saudi_tax_industry_placeholder'] = 'Settore o posizione';
$lang['config_saudi_tax_seller_id'] = 'ID venditore';
$lang['config_saudi_tax_seller_tax_id'] = 'Partita IVA venditore';
$lang['config_saudi_tax_seller_scheme_id'] = 'ID schema venditore';
$lang['config_saudi_tax_seller_scheme_id_select'] = 'Seleziona l\'ID schema';
$lang['config_saudi_tax_postal_street_name'] = 'Nome della via postale';
$lang['config_saudi_tax_postal_building_number'] = 'Numero civico postale';
$lang['config_saudi_tax_postal_code'] = 'Codice Postale';
$lang['config_saudi_tax_postal_code_placeholder'] = 'Deve essere di 5 cifre.';
$lang['config_saudi_tax_postal_city_name'] = 'Nome della città postale';
$lang['config_saudi_tax_postal_district_name'] = 'Nome del distretto postale';
$lang['config_saudi_tax_postal_plot'] = 'Trama postale';
$lang['config_saudi_tax_postal_country'] = 'Paese postale';
$lang['config_saudi_tax_renew'] = 'Rinnovare';
$lang['config_saudi_tax_generate'] = 'creare';
...
$lang['config_vidapay_info'] = 'Impostazioni VIDAPAY';
$lang['config_update_vidapay_catalog_for_existing_items'] = 'Aggiorna il catalogo VIDAPAY per gli articoli esistenti';

$lang['config_work_order_warranty_checked_product_price_zero'] = 'Prezzo del prodotto pari a zero se la garanzia è verificata';



$lang['config_show_custom_fields_service_tag_work_orders'] = 'Mostra campi personalizzati sul numero di matricola';
$lang['config_show_custom_fields_label_service_tag_work_orders'] = 'Mostra l\'etichetta dei campi personalizzati sul numero di matricola';
$lang['config_show_estimated_repair_date_on_service_tag_work_orders'] = 'Mostra la data di riparazione stimata sul numero di matricola';
$lang['config_change_to_recv_when_unsuspending_po'] = 'Passare alla modalità di ricezione quando si annulla la sospensione dell\'ordine d\'acquisto';
$lang['config_scale_8'] = 'Peso Codice a barre incorporato EAN 13 4 cifre di peso';
$lang['config_dont_show_images_in_search_suggestions'] = 'NON mostrare le immagini nei suggerimenti di ricerca';


$lang['config_new_item_web_hook'] = 'Nuovo oggetto Web Hook';
$lang['config_edit_item_web_hook'] = 'Modifica elemento web hook';
$lang['config_edit_work_order_web_hook'] = 'Modifica web hook dell\'ordine di lavoro';
$lang['config_new_work_order_web_hook'] = 'Nuovo web hook dell\'ordine di lavoro';


$lang['config_work_orders_show_condensed_receipt'] = 'Mostra ricevuta abbreviata per ordini di lavoro';



$lang['config_square_terminal_get_id'] = 'Ottieni il codice dispositivo quadrato';
$lang['config_device_id'] = 'ID dispositivo quadrato';

$lang['config_work_orders_show_condensed_receipt'] = 'Mostra ricevuta abbreviata per ordini di lavoro';

$lang['config_square_terminal_delete_id'] = 'Annulla la registrazione del terminale';

$lang['config_connect_to_woocommerce'] = 'Connettiti a Woocommerce';
$lang['config_woocommerce_oauth_set_alert'] = 'Stiamo aggiornando la sincronizzazione di Woo Commerce per renderla in tempo reale. Affinché Woo Commerce continui a funzionare, deve essere ripristinato. Fare clic qui sotto per effettuare la configurazione.';

$lang['config_prompt_for_sale_id_on_return'] = 'Richiedi ID vendita al momento del reso';

$lang['delivery_url_https_error'] = 'delivery_url non utilizza HTTPS.';

$lang['config_do_not_allow_sales_with_zero_value_line_items'] = 'Non consentire elementi pubblicitari con valore zero';

$lang['config_return_reasons'] = 'Motivi del reso';
$lang['config_require_customer_for_return'] = 'Richiedi al cliente il reso';
$lang['config_require_receipt_for_return'] = 'Richiedere ricevuta per il reso';


$lang['config_shopifycommerce_oauth_set_alert'] = 'Stiamo aggiornando la sincronizzazione di Shopify per renderla in tempo reale. Affinché Shopify possa continuare a funzionare, è necessario reimpostarlo. Fare clic qui sotto per effettuare la configurazione';

$lang['config_show_total_at_top_on_receipt'] = 'Mostra il totale in alto sulla ricevuta';


$lang['config_ecommerce_realtime'] = 'Sincronizzazione in tempo reale';
$lang['config_dont_lock_suspended_sales'] = 'NON bloccare le vendite sospese per evitare accessi duplicati';
$lang['config_show_exchanged_totals_on_receipt'] = 'Mostra i totali scambiati sulla ricevuta';
$lang['config_show_prices_on_work_orders'] = 'Mostra i prezzi sul foglio dell\'ordine di lavoro';
?>